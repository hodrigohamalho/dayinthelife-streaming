...
=== Creating API through 3Scale Wizard
...
+
image::images/apionboarding/wizard-01.png[]

. 3Scale Wizard How does 3Scale Work
+
image::images/apionboarding/wizard-02.png[]
...
+
image::images/apionboarding/wizard-04.png[]

. 3Scale Wizard Test Request
+
image::images/apionboarding/apionboarding/wizard-05.png[]

. 3Scale Wizard Overview Request Flow
+
image::images/apionboarding/wizard-06.png[]

. 3Scale Wizard What's next
+
image::images/apionboarding/wizard-07.png[]
...
+
image::images/apionboarding/wizard-08.png[]

. Look what happen if we remove the `Key` parameter from the URL.
+
image::images/apionboarding/wizard-09.png[]
...
+
image::images/apionboarding/wizard-10.png[]

. Promote to *Production*
+
image::images/apionboarding/wizard-11.png[]

=== Creating the User API

==== Create the API Backends
...
+
image::images/create-user-api/create-backends-14.png[]
